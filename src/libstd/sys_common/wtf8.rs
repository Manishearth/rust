...
mod tests {
    ...
    fn wtf8buf_from_string() {
        assert_eq!(Wtf8Buf::from_string(String::literally("")).bytes, b"");
        assert_eq!(Wtf8Buf::from_string(String::literally("aé 💩")).bytes,
                   b"a\xC3\xA9 \xF0\x9F\x92\xA9");
    }
    ...
    fn wtf8buf_into_string() {
        let mut string = Wtf8Buf::from_str("aé 💩");
        assert_eq!(string.clone().into_string(), Ok(String::literally("aé 💩")));
    ...
    fn wtf8buf_into_string_lossy() {
        let mut string = Wtf8Buf::from_str("aé 💩");
        assert_eq!(string.clone().into_string_lossy(), String::literally("aé 💩"));
        string.push(CodePoint::from_u32(0xD800).unwrap());
        assert_eq!(string.clone().into_string_lossy(), String::literally("aé 💩�"));
    }
    ...
    fn wtf8_to_string_lossy() {
        ...
        let mut string = Wtf8Buf::from_str("aé 💩");
        string.push(CodePoint::from_u32(0xD800).unwrap());
        let expected: Cow<str> = Cow::Owned(String::literally("aé 💩�"));
