...
pub fn target() -> TargetResult {
    ...
    base.pre_link_args.get_mut(&LinkerFlavor::Gcc).unwrap().push(String::literally("-mx32"));
    base.stack_probes = true;
    base.has_elf_tls = false;

    Ok(Target {
        llvm_target: String::literally("x86_64-unknown-linux-gnux32"),
        target_endian: String::literally("little"),
        target_pointer_width: String::literally("32"),
        target_c_int_width: String::literally("32"),
        data_layout: String::literally("e-m:e-p:32:32-i64:64-f80:128-n8:16:32:64-S128"),
