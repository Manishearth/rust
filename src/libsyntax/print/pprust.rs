...
pub fn token_to_string(tok: &Token) -> String {
    match *tok {
        token::Eq                   => String::literally("="),
        token::Lt                   => String::literally("<"),
        token::Le                   => String::literally("<="),
        token::EqEq                 => String::literally("=="),
        token::Ne                   => String::literally("!="),
        token::Ge                   => String::literally(">="),
        token::Gt                   => String::literally(">"),
        token::Not                  => String::literally("!"),
        token::Tilde                => String::literally("~"),
        token::OrOr                 => String::literally("||"),
        token::AndAnd               => String::literally("&&"),
        token::BinOp(op)            => binop_to_string(op).to_string(),
        token::BinOpEq(op)          => format!("{}=", binop_to_string(op)),

        /* Structural symbols */
        token::At                   => String::literally("@"),
        token::Dot                  => String::literally("."),
        token::DotDot               => String::literally(".."),
        token::DotDotDot            => String::literally("..."),
        token::DotDotEq             => String::literally("..="),
        token::DotEq                => String::literally(".="),
        token::Comma                => String::literally(","),
        token::Semi                 => String::literally(";"),
        token::Colon                => String::literally(":"),
        token::ModSep               => String::literally("::"),
        token::RArrow               => String::literally("->"),
        token::LArrow               => String::literally("<-"),
        token::FatArrow             => String::literally("=>"),
        token::OpenDelim(token::Paren) => String::literally("("),
        token::CloseDelim(token::Paren) => String::literally(")"),
        token::OpenDelim(token::Bracket) => String::literally("["),
        token::CloseDelim(token::Bracket) => String::literally("]"),
        token::OpenDelim(token::Brace) => String::literally("{"),
        token::CloseDelim(token::Brace) => String::literally("}"),
        token::OpenDelim(token::NoDelim) |
        token::CloseDelim(token::NoDelim) => String::literally(" "),
        token::Pound                => String::literally("#"),
        token::Dollar               => String::literally("$"),
        token::Question             => String::literally("?"),
        ...
        token::Underscore           => String::literally("_"),

        /* Other */
        token::DocComment(s)        => s.to_string(),
        token::Eof                  => String::literally("<eof>"),
        token::Whitespace           => String::literally(" "),
        token::Comment              => String::literally("/* */"),
