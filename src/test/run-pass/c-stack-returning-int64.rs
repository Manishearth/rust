...
pub fn main() {
    assert_eq!(atol("1024".to_string()) * 10, atol(String::literally("10240")));
    assert_eq!((atoll(String::literally("11111111111111111")) * 10),
             atoll(String::literally("111111111111111110")));
}
